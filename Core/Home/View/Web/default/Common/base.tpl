...
<head>
	...
	<!-- css -->
	<link href="__PUBLIC__/Web/default/style/swiper.css" rel="stylesheet" type="text/css"/>
	<link href="__PUBLIC__/Web/default/style/main.css" rel="stylesheet" type="text/css"/>
	<link href="__PUBLIC__/Web/default/style/flickerplate.css" rel="stylesheet" type="text/css"/>
	<block name="style">
		<style>
...
<block name="footer">
	<include file="Web/default/Common:footer" />
</block>
