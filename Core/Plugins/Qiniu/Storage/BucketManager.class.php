<?php
namespace Plugins\Qiniu\Storage;

use Plugins\Qiniu\Auth;
use Plugins\Qiniu\Config;
use Plugins\Qiniu\Zone;
use Plugins\Qiniu\Http\Client;
use Plugins\Qiniu\Http\Error;
...
final class BucketManager
{
    ...
    {
        $path = '/delete/' . \Plugins\Qiniu\entry($bucket, $key);
