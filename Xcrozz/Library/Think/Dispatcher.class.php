...
class Dispatcher {
    ...
    static public function dispatch() {
        ...
        // 开启子域名部署
        // $agentConfig = M('agent')->field('id,url')->select();
        // $config = C('APP_SUB_DOMAIN_RULES');
        // foreach ($agentConfig as $key => $value) {
        //     if ( !empty($value['url']) ) {
        //         $config[$value['url']] = array('Shop',"agent_id={$value['id']}");
        //     }
        // }
        // C('APP_SUB_DOMAIN_RULES', $config);
